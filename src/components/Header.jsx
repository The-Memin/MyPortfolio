                                ...
                                <a target="_blank" href="https://www.linkedin.com/in/guillermo-juarez-martinez-665b66262/" className="flex items-center transition md:justify-center md:hover:scale-105">
                                    <div className="flex items-center ">
                                        <span className="relative inline-flex overflow-hidden rounded-full p-[1px]">
                                            ...
                                            <div className="inline-flex items-center justify-center w-full px-3 py-1 text-sm text-green-800 rounded-full cursor-pointer bg-slate-800 dark:text-white/80 backdrop-blur-3xl whitespace-nowrap">
