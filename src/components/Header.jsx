    ...
    return(
        <header className="w-full p-4 flex flex-col items-center">
            ...
            <section className="relative w-full lg:py-28 flex flex-col items-center">
                <article ref={containerRef} className="pt-[6rem] w-full max-w-screen-lg">
                    <div className="flex flex-col gap-2">
                        <div className="text-name">
                            ...
                            <div className="overflow-hidden mt-8">
                                <h2 className="text-2xl lg:text-4xl item-name">
                                    Hi!, I'm <strong className="font-semibold">Guillermo JM</strong> a
                                </h2>
                            </div>
                        </div>
                        <h1 className="text-5xl lg:text-8xl font-semibold item-text">Web Developer</h1>
