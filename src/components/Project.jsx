...
export function Project({project}){
    return(
        <li className="mt-16 lg:mt-10">
            <div className="flex flex-col gap-6 lg:grid grid-cols-2 lg:gap-10 group">
                <figure className="relative project-img rounded-md overflow-hidden grid place-items-center bg-slate-100">
