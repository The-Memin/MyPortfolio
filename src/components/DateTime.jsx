...
export function DateTime({position, company, date, description, companyLink}){
    return(
        <li className='realtive flex pl-8 flex-col gap-5 md:gap-0 md:flex-row md:items-center'>
            <div className='relative md:w-2/5 lg:p-8 text-start md:text-end flex flex-col gap-1 md:pr-[5rem] text-nowrap before:content-[""] before:absolute before:h-[250%] md:before:h-full before:border-l-2 before:border-black/20 dark:before:border-white/15 before:left-[-1.5em] md:before:left-auto md:before:right-0 pb-8'>
